<template>
  <div class="home container">
    ...
    <ul class="d-flex flex-column col-2">
       <li class="mb-4"><router-link to="/cart" class="navButton">購物車</router-link></li>
  ...
  <footer class="d-flex justify-content-between align-items-center footer">
    ...
    <ul>
      ...
      <li class="text-white">本網站由ccysteak公司所有</li>
    </ul>
