...
<div class="container">
  ...
  <div class="row bigtopSpacing justify-content-center sectionSpcing">
    ...
    <div class="formBorder bigbotSpacing">
      <h2 class="menuTitle col-12 col-sm-8 d-flex justify-content-center mt-3 mb-3 ml-auto mr-auto" >請填寫付款資料</h2>
      <validation-observer ref="observer">
        <b-form slot-scope="{ validate }">
          <div class="row justify-content-center align-items-center mb-3">
            <div class="d-flex justify-content-center align-items-center col-12">
              <ValidationProvider rules="required" name="姓名" class="col-12 col-sm-6">
            ...
            <div class="d-flex justify-content-center align-items-center col-12">
              <ValidationProvider rules="required|email" name="Email" class="col-12 col-sm-6">
            ...
            <div class="d-flex justify-content-center align-items-center col-12">
              <ValidationProvider rules="required|numeric" name="聯絡電話" class="col-12 col-sm-6">
            ...
            <div class="d-flex justify-content-center align-items-center col-12">
              <b-form-group label="付款方式：" class="col-12 col-sm-6 activityTitle">
                <b-form-select v-model="payment" placeholder="請選擇付款方式" :options="options"></b-form-select>
              </b-form-group>
            </div>
            <div class="d-flex justify-content-center align-items-center col-12">
              <ValidationProvider rules="required" name="寄送地址" class="col-12 col-sm-6">
            ...
            <div class="d-flex justify-content-center align-items-center col-12">
              <b-form-group label="優惠券代碼：" class="col-12 col-sm-6 activityTitle">
                <b-form-input v-model="coupon" placeholder="請輸入優惠券代碼(若無可不填)"></b-form-input>
              </b-form-group>
            </div>
            <div class="d-flex justify-content-center align-items-center col-12">
              <b-form-group label="備註：" class="col-12 col-sm-6 activityTitle">
