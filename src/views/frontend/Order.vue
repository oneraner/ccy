    ...
    <div class="pinkBorder mb-3">
      ...
      <b-form slot-scope="{ validate }">
        <div class="row justify-content-center mb-3">
          <div class="d-flex justify-content-between align-items-center col-3 flex-nowrap">
            <ValidationProvider rules="required" name="姓名">
              <b-form-group slot-scope="{ valid, errors }" label="姓名：" label-cols="4">    
                <b-form-input 
          ...
          <div class="d-flex justify-content-center align-items-center col-4">
            <ValidationProvider rules="required|email" name="Email">
              <b-form-group slot-scope="{ valid, errors }" label="E-mail：" class="m-0" label-cols="4">
          ...
          <div class="d-flex justify-content-start align-items-center col-5">
            <b-form-group label="優惠券代碼：" class="m-0" label-cols="4">
        ...
        <div class="row justify-content-start mb-3">
          <div class="d-flex justify-content-between align-items-center col-4">
            <ValidationProvider rules="required|numeric" name="聯絡電話">
              <b-form-group slot-scope="{ valid, errors }" label="聯絡電話：" class="m-0" label-cols="4">
          ...
          <div class="d-flex justify-content-start align-items-center col-3">
            <b-form-group label="付款方式：" class="m-0" label-cols="6">
          ...
          <div class="d-flex justify-content-start align-items-center col-5">
            <ValidationProvider rules="required" name="寄送地址">
              <b-form-group label="寄送地址：" class="m-0" label-cols="4" slot-scope="{ valid, errors }">
        ...
        <div class="row mb-3">
          <b-form-group label="備註：" class="col-7 m-0" label-cols="2">
        ...
        <div class="d-flex justify-content-center align-items-center col-5">
            <b-button pill variant="outline-primary" class="cartButton" @click.prevent="validate().then(postOrder)">送出訂單</b-button>
        </div>
        </div>
      </b-form>
    </validation-observer>
